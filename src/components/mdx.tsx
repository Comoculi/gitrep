...
function createVideo({ src, alt, ...props }: { src: string; alt?: string } & React.VideoHTMLAttributes<HTMLVideoElement>) {
  if (!src) {
    console.error("createVideo requires a valid 'src' property.");
    return null;
  }
  ...
  return (
      ...
      >
        ...
        {alt && <track kind="descriptions" srcLang="en" label={alt} />}
